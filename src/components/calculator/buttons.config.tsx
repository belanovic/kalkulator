...
import { Percent, Divide, X, Minus, Plus, Trash2, Delete, Sigma, Pi, Info, HelpCircle, Equal, CornerDownLeft, RotateCcw } from 'lucide-react';
...
export const calculatorButtonsLayout: ButtonConfig[][] = [
  ...
  [
    { id: 'sign', label: '+/-', value: '+/-', type: 'sign', ariaLabel: 'Toggle Sign' },
