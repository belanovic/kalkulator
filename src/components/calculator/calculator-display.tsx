  ...
  return (
    <div className="bg-card/80 dark:bg-neutral-800/80 p-4 rounded-t-lg shadow-inner relative min-h-[120px] flex flex-col justify-end text-right overflow-hidden">
      ...
      <ScrollArea className="h-8 w-full mb-1">
        <p className="text-sm text-muted-foreground break-all whitespace-nowrap pl-2 pr-10" aria-label="Current expression">
      ...
      <ScrollArea className="h-14 w-full">
        <p 
          className="text-4xl lg:text-5xl font-headline font-semibold text-primary break-all whitespace-nowrap pl-2 pr-10"
          aria-live="polite"
